...
export default function SearchForm(){
    ...
    return(
        <Form className="w-auto" action="/search">
            ...
            <label htmlFor="movieRadio" className="block text-white ml-[2.4rem] mt-[-1.7rem] w-[1rem]">Movies</label>
            ...
            <label htmlFor="showRadio" className="block text-white ml-[8.3rem] mt-[-1.7rem] w-[1rem]">Shows</label>
            <input type="text" name="query" placeholder="  Search..." className="block w-[93%] placeholder-red-600 sm:w-[95%] md:w-[98%] pt-1 pb-1 ml-4 bg-amber-950"/>
        </Form>
    )
}